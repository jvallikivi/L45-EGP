# Note
This is a vendor of the ogbg-mol examples folder from the [Open Graph Benchmark GitHub repository](https://github.com/snap-stanford/ogb/tree/master/examples/graphproppred/mol).
